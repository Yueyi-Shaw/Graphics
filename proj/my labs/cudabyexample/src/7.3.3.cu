...
int main(void)
{
    ...
    HANDLE_ERROR(cudaBindTexture(NULL, texConstSrc, data.dev_constSrc, desc, imageSize));
    HANDLE_ERROR(cudaBindTexture(NULL, texIn, data.dev_inSrc, desc, imageSize));
    HANDLE_ERROR(cudaBindTexture(NULL, texOut, data.dev_outSrc, desc, imageSize));
